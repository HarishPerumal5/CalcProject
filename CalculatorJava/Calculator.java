...
public class Calculator extends Frame implements ActionListener {
    ...
    Button btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, plus, minus, divison, multiply, equals, clear;
    TextField display;
    ...
    Calculator() {
        ...
        btn2 = new Button("2");
        btn2.setBounds(150, 300, 80, 86);
        btn2.addActionListener(this);

        btn3 = new Button("3");
        btn3.setBounds(250, 300, 80, 86);
        ...
        divison = new Button("/");
        divison.setBounds(350, 400, 80, 80);
